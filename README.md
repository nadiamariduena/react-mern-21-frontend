...
## Duplicate the product and add a hr to separate them
...
## SUMMARIZE / The amount | total of the products inside the cart

- I changed a couple of things inside the styles, you can check the original code here:

[safak](https://github.com/safak/youtube/blob/react-shop-ui/src/pages/Cart.jsx)
...
[<img src="/src/img/styles_checkout-default5.gif" />]()
...
- I like to give it a lot of space because its more easy to read, mostly in the beginning.
